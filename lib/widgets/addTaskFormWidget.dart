...
import 'package:TaskTurtle/widgets/colors.dart';
import 'package:flutter/material.dart';

import 'hand_cursor.dart';

class AddForm extends StatefulWidget {
  AddForm(this.focused, this.addNewItem);
...
typedef addItemCallback = void Function(TaskModel p, TaskModel c);
              ...
              onPressed: () {
                if (_formKey.currentState.validate()) {
                  widget.addNewItem(widget.focused,
                      new TaskModel(title: title.text, deadline: date.text, path: widget.focused.path + [widget.focused]));
                }
              },
              child: Text("Create"),
            )
